    ...
    if request.method == "POST":
        ...
        try:
            videos = Video.objects.filter(
                title__unaccent__lower__trigram_similar=query,
                private=False,
                unlisted=False,
            )
        except:
            videos = Video.objects.filter(
                title__contains=query, private=False, unlisted=False
            )
            ...
            try:
                ...
                if not video.channel.user == viewer:  # type: ignore
                    return HttpResponseForbidden(
                        "<h1>Forbidden</h1><h4>Video is private</h4>"
                    )
    ...
    if request.user.is_authenticated:
        try:
            ...
            try:
                ...
                for channel in my_channels:
                    channel_playlists = (
                        Playlist.objects.filter(channel=channel).in_bulk().values()
                    )
                    for channel_playlist in channel_playlists:
                        my_playlists.append(channel_playlist)
                context["playlists"] = my_playlists
...
def watch_playlist(request, pk, number):
    ...
    try:
        ...
        return HttpResponseBadRequest(
            "<h1>404 Not Found</h1><h3>Playlist Does Not Exist! SORRYYY</h3>"
        )
        ...
        if request.user.is_authenticated:
            try:
                ...
                if not playlist.channel.user == viewer:  # type: ignore
                    return HttpResponseForbidden(
                        "<h1>Forbidden</h1><h4>Playlist is private</h4>"
                    )
    ...
    try:
        ...
        return HttpResponseBadRequest(
            "<h1>404 Not Found</h1><h3>Video Does Not Exist! SORRYYY</h3>"
        )
...
def channnel_view(request, pk):
    try:
        ...
        return HttpResponse(
            "<h1>404 Not Found</h1><h4>Channel Does Not Exist! SORRYYY</h4>"
        )
    ...
    if request.user.is_authenticated:
        try:
            ...
            try:
                ...
                private_playlists = Playlist.objects.filter(
...
def playlist(request, pk):
    ...
    if request.user.is_authenticated:
        try:
            ...
            return HttpResponse(
                "<h1>404 Not Found</h1><h4>Playlist Does Not Exist! SORRYYY</h4>"
            )
    ...
    if request.user.is_authenticated:
        ...
        try:
            ...
            for channel in channels:
                videos_dict = (
                    channel.video_set.filter(private=False, unlisted=False)
                    .in_bulk()
                    .values()
                )
                for video in videos_dict:
...
def edit_playlist_view(request, pk):
    if request.user.is_authenticated:
        ...
        if not viewer == playlist.channel.user:
            return JsonResponse(
                {"success": False, "message": "You don't own this Playlist"}
            )
        context["playlist"] = playlist
...
def edit_video_view(request, pk):
    if request.user.is_authenticated:
        ...
        if not viewer == video.channel.user:  # type: ignore
            return JsonResponse(
                {"success": False, "message": "You don't own this Video"}
            )
        context["video"] = video
    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            try:
                ...
                return JsonResponse(
                    {"success": False, "message": "Playlist Does Not Exist"}
                )
            viewer = request.user.viewer
            if not viewer == playlist.channel.user:
                return JsonResponse(
    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            try:
                ...
                return JsonResponse(
                    {"success": False, "message": "Video Does Not Exist"}
                )
            viewer = request.user.viewer
            if not viewer == video.channel.user:  # type: ignore
                return JsonResponse(
            ...
            try:
                ...
                if channel.user == viewer:
                    return JsonResponse(
                        {
                            "success": False,
                            "error": "You cannot unsubscribe from your own channel.",
                        }
                    )
        ...
        if request.method == "POST":
            try:
                ...
                if liked_videos.videos.contains(video):
                    ...
                    video.save()
                    return JsonResponse(
                        {"success": True, "liked": True, "likes_count": video.likes}
                    )
    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            try:
                ...
                video.save()
                return JsonResponse(
                    {"success": True, "liked": False, "likes_count": video.likes}
                )
    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            if not channel.user == viewer:  # type: ignore
                return JsonResponse(
                    {"success": False, "message": "You Don't own this Channel"}
                )
            try:
                channel.delete()
                return JsonResponse(
    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            if not comment_reply.channel.user == viewer:  # type: ignore
                return JsonResponse(
                    {"success": False, "message": "You Don't own this Comment reply"}
                )
            try:
                comment_reply.delete()
                return JsonResponse(
                    {"success": True, "message": "Comment reply Deleted Successfully"}
                )
            except:
                return JsonResponse({"success": False, "message": "Deletion Failed"})
        ...
        if request.method == "POST":
            try:
                ...
                comment_reply = CommentReply(
                    comment=comment, reply=reply_text, channel=channel
                )
                comment_reply.save()
                return JsonResponse({"success": True})
            except:
    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            if disliked_comments.comments.contains(viewer):
                return JsonResponse(
                    {"success": False, "message": "Comment already disliked"}
                )
